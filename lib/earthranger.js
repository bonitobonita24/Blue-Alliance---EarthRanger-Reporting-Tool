...
export async function getPatrol(patrolId) {
  return erFetch(`/activity/patrols/${patrolId}/`);
}
...
export async function getSubjectTracks(subjectId, since, until) {
  return erFetch(`/subject/${subjectId}/tracks/`, { query: { since, until } });
}
